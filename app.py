...
APP_RELEASE = "2026-07-06 ai-normalize-hotfix-5"
...
.custom-card, div[data-testid="stVerticalBlockBorder"] {
...
.custom-card:hover, div[data-testid="stVerticalBlockBorder"]:hover {
    transform: translateY(-3px) !important;
    border-color: rgba(56, 189, 248, 0.7) !important;
    box-shadow: 0 15px 35px 0 rgba(14, 165, 233, 0.25) !important;
}
